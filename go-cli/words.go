...
func registerSDKWords(r *eng.Registry, client *sdk.UuidGeneratorSDK) {
...
func runOp(client *sdk.UuidGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
