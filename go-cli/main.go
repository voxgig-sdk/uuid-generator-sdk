// Command UuidGenerator-cli is a CLI + REPL for the UuidGenerator SDK,
...
const prompt = "uuid-generator"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "decode timestamp_first version_1 version_3 version_4 version_5"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      UUID_GENERATOR_APIKEY (api key), UUID_GENERATOR_BASE (base url override)")
