...
// UuidGenerator SDK TimestampFirst entity
...
class TimestampFirstEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TimestampFirstEntity($this->_client, $opts);
    }

    /**
     * @param TimestampFirst|array $args TimestampFirst data (assoc-array) to store.
     */
    ...
    /**
     * @return TimestampFirst|array The current TimestampFirst data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TimestampFirst fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TimestampFirst fields).
     */
     ...
     *
     * @param TimestampFirstLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TimestampFirstLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TimestampFirst|array The loaded TimestampFirst as an assoc-array at the
     ...
     *
     * @param TimestampFirstListMatch|array|null $reqmatch Match filter (any subset
     *   of TimestampFirst fields) as an assoc-array; TimestampFirstListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TimestampFirst[]|array A list of TimestampFirst items as assoc-arrays at
