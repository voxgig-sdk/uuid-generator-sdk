...
class Version3Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Version3Entity($this->_client, $opts);
    }

    /**
     * @param Version3|array $args Version3 data (assoc-array) to store.
     */
    ...
    /**
     * @return Version3|array The current Version3 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Version3 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Version3 fields).
     */
     ...
     *
     * @param Version3LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed Version3LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Version3|array The loaded Version3 as an assoc-array at the
