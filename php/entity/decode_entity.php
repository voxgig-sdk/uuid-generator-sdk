...
class DecodeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DecodeEntity($this->_client, $opts);
    }

    /**
     * @param Decode|array $args Decode data (assoc-array) to store.
     */
    ...
    /**
     * @return Decode|array The current Decode data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Decode fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Decode fields).
     */
     ...
     *
     * @param DecodeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DecodeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Decode|array The loaded Decode as an assoc-array at the
