...
class TimestampFirstEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set UUIDGENERATOR_TEST_TIMESTAMP_FIRST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function timestamp_first_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("UUIDGENERATOR_TEST_TIMESTAMP_FIRST_ENTID");
