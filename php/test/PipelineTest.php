...
// UuidGenerator SDK pipeline test
//
...
{
    private static function utility(): UuidGeneratorUtility
    {
        return new UuidGeneratorUtility();
    }
    ...
    private static function ctx(array $over = []): UuidGeneratorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UuidGeneratorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UuidGeneratorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UuidGeneratorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UuidGeneratorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UuidGeneratorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UuidGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UuidGeneratorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UuidGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UuidGeneratorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UuidGeneratorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UuidGeneratorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UuidGeneratorResponse([]),
            'result' => new UuidGeneratorResult([]),
        ]);
        [, $err] = UuidGeneratorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UuidGeneratorSpec([]),
            'response' => null,
            'result' => new UuidGeneratorResult([]),
        ]);
        [, $err] = UuidGeneratorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UuidGeneratorSpec(['step' => 's']),
            'response' => new UuidGeneratorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UuidGeneratorResult([]),
        ]);
        [, $err] = UuidGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UuidGeneratorSpec(['step' => 's']),
            'response' => new UuidGeneratorResponse(self::resp(200, ['v' => 1])),
            'result' => new UuidGeneratorResult([]),
        ]);
        [, $err] = UuidGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UuidGeneratorSpec(['step' => 's']),
            'response' => new UuidGeneratorResponse(self::resp(200, ['v' => 2])),
            'result' => new UuidGeneratorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UuidGeneratorMakeResponse::call($ctx);
    ...
    {
        $preset = new UuidGeneratorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UuidGeneratorSpec([]),
            'response' => new UuidGeneratorResponse([]),
            'result' => new UuidGeneratorResult([]),
        ...
        [$got, $err] = UuidGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UuidGeneratorResult([])]);
        [, $err] = UuidGeneratorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UuidGeneratorSpec([]), 'result' => null]);
        [, $err] = UuidGeneratorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UuidGeneratorSpec(['step' => 's']),
            'result' => new UuidGeneratorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UuidGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UuidGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UuidGeneratorSpec(['step' => 's']),
            'result' => new UuidGeneratorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UuidGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UuidGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UuidGeneratorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UuidGeneratorSpec([]),
            'result' => new UuidGeneratorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UuidGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UuidGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UuidGeneratorError('boom', 'boom');
        $utility->fetcher = function (UuidGeneratorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UuidGeneratorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UuidGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UuidGeneratorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UuidGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UuidGeneratorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UuidGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UuidGeneratorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UuidGeneratorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UuidGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UuidGeneratorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UuidGeneratorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UuidGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UuidGeneratorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UuidGeneratorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UuidGeneratorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UuidGeneratorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UuidGeneratorResult(['ok' => false])]);
        $this->expectException(UuidGeneratorError::class);
        UuidGeneratorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UuidGeneratorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UuidGeneratorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UuidGeneratorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UuidGeneratorBaseFeature();
        $b = new UuidGeneratorBaseFeature();
        UuidGeneratorFeatureAdd::call($ctx, $a);
        UuidGeneratorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UuidGeneratorBaseFeature
    {
        $f = new UuidGeneratorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UuidGeneratorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UuidGeneratorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UuidGeneratorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UuidGeneratorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UuidGeneratorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UuidGeneratorResponse(['headers' => null]),
            'result' => new UuidGeneratorResult([]),
        ]);
        UuidGeneratorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UuidGeneratorResultBody::call($ctx);
