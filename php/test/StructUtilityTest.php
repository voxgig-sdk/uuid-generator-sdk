...
// UuidGenerator SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UuidGeneratorOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UuidGeneratorOmni::structfix($now, Struct::undef()))
                        !== json_encode(UuidGeneratorOmni::structfix($val, Struct::undef()))) {
