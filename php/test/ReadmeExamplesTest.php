...
// UuidGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UuidGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'UuidGeneratorSDK';
    ...
    private const SDK_BASE = 'uuidgenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../uuidgenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
