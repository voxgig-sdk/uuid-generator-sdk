...
class Version5DirectTest extends TestCase
{
    public function test_direct_load_version_5(): void
    {
        $setup = version_5_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-version_5", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
