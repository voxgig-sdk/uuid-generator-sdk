...
class Version4EntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        [$version_4_ref01_list_result, $err] = $version_4_ref01_ent->list($version_4_ref01_match, null);
        $this->assertNull($err);
        $this->assertIsArray($version_4_ref01_list_result);

        // LOAD
        $version_4_ref01_match_dt0 = [];
        [$version_4_ref01_data_dt0_loaded, $err] = $version_4_ref01_ent->load($version_4_ref01_match_dt0, null);
        $this->assertNull($err);
