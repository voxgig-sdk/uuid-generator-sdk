...
class Version4EntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set UUID_GENERATOR_TEST_VERSION_4_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function version_4_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("UUID_GENERATOR_TEST_VERSION_4_ENTID");
