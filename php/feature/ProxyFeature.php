...
// UuidGenerator SDK proxy feature
...
class UuidGeneratorProxyFeature extends UuidGeneratorBaseFeature
{
    ...
    public function init(UuidGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UuidGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
