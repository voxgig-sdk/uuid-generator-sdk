...
// UuidGenerator SDK cache feature
...
class UuidGeneratorCacheFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _through(UuidGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
