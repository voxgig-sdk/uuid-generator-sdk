...
// UuidGenerator SDK audit feature
...
class UuidGeneratorAuditFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _emit(UuidGeneratorContext $ctx, string $outcome): void
    {
