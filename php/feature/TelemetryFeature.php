...
// UuidGenerator SDK telemetry feature
...
class UuidGeneratorTelemetryFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _close(UuidGeneratorContext $ctx, bool $ok): void
    {
