...
// UuidGenerator SDK timeout feature
...
class UuidGeneratorTimeoutFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _with_timeout(UuidGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UuidGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
