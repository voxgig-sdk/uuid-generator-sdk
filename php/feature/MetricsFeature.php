...
// UuidGenerator SDK metrics feature
...
class UuidGeneratorMetricsFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _record(UuidGeneratorContext $ctx, bool $ok): void
    {
