...
// UuidGenerator SDK netsim feature
...
class UuidGeneratorNetsimFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _simulate(UuidGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UuidGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
