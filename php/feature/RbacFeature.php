...
// UuidGenerator SDK rbac feature
...
class UuidGeneratorRbacFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _required(UuidGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(UuidGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(UuidGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
