...
// UuidGenerator SDK debug feature
...
class UuidGeneratorDebugFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _finish(UuidGeneratorContext $ctx, bool $ok): void
    {
