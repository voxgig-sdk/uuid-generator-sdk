...
// UuidGenerator SDK streaming feature
...
class UuidGeneratorStreamingFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _iterate(UuidGeneratorResult $result): \Generator
    {
    ...
    private function _streamable(UuidGeneratorContext $ctx): bool
    {
