...
// UuidGenerator SDK utility: fetcher

class UuidGeneratorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UuidGeneratorSDK/1.0)';
    ...
    public static function call(UuidGeneratorContext $ctx, string $fullurl, array $fetchdef): array
    {
