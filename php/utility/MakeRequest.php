...
// UuidGenerator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UuidGeneratorMakeRequest
{
    public static function call(UuidGeneratorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UuidGeneratorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UuidGeneratorResponse($fetched);
        } else {
