...
The PHP SDK for the UuidGenerator API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Decode(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->UuidGenerator(null)->load(
    ["id" => "test01"], null
);
