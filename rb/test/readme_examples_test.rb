...
#      offline in seeded test mode (UuidGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UuidGenerator_sdk.rb")
  SDK_CLASS = "UuidGeneratorSDK"
