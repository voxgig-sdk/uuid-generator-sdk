...
class Version4EntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set UUID_GENERATOR_TEST_VERSION_4_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def version_4_basic_setup(extra)
  ...
  entid_env_raw = ENV["UUID_GENERATOR_TEST_VERSION_4_ENTID"]
