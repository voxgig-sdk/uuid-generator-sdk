...
class TimestampFirstEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set UUIDGENERATOR_TEST_TIMESTAMP_FIRST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def timestamp_first_basic_setup(extra)
  ...
  entid_env_raw = ENV["UUIDGENERATOR_TEST_TIMESTAMP_FIRST_ENTID"]
