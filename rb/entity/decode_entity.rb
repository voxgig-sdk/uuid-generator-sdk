...
class DecodeEntity
  ...
  # @return [Decode, Hash] the current Decode data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Decode fields)
  def match_get
  ...
  # Load a single Decode.
  #
  # @param reqmatch [DecodeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Decode.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Decode, Hash] the loaded Decode; raises UuidGeneratorError on failure
