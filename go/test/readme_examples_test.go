...
const testSeed = `map[string]any{"entity": map[string]any{"decode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "timestamp_first": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version_1": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version_3": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version_4": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version_5": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
