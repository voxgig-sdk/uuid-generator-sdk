...
func TestVersion5Entity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		version5Ref01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.version_5")))
...
func version_5BasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("UUID_GENERATOR_TEST_VERSION_5_ENTID")
	...
	idmapResolved := core.ToMapAny(env["UUID_GENERATOR_TEST_VERSION_5_ENTID"])
