...
// instead of `sdk.NewUuidGeneratorSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *UuidGeneratorSDK  { return NewUuidGeneratorSDK(nil) }
func Test() *UuidGeneratorSDK { return TestSDK(nil, nil) }
