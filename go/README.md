...
## Install
```bash
go get github.com/voxgig-sdk/uuid-generator-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/uuid-generator-sdk=../path/to/github.com/voxgig-sdk/uuid-generator-sdk
```
...
```
github.com/voxgig-sdk/uuid-generator-sdk/
...
The root package (`github.com/voxgig-sdk/uuid-generator-sdk`) re-exports everything needed
