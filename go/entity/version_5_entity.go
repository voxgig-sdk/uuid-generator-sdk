...
func NewVersion5Entity(client *core.UuidGeneratorSDK, entopts map[string]any) *Version5Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Version5Entity) GetName() string { return e.name }
...
func (e *Version5Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Version5Entity) Deleted() bool {
	return e.deleted
}


func (e *Version5Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVersion5Entity(e.client, opts)
}

func (e *Version5Entity) Data(args ...any) any {
...
func (e *Version5Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Version5; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Version5Entity) DataTyped(data ...Version5) Version5 {
	if len(data) > 0 {
		return typedFrom[Version5](e.Data(asMap(data[0])))
	}
	return typedFrom[Version5](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Version5 (all fields
// optional at the wire level).
func (e *Version5Entity) MatchTyped(match ...Version5) Version5 {
	if len(match) > 0 {
		return typedFrom[Version5](e.Match(asMap(match[0])))
	}
	return typedFrom[Version5](e.Match())
}
...
func (e *Version5Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Version5Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Version5LoadMatch and returns an Version5. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *Version5Entity) LoadTyped(reqmatch Version5LoadMatch, ctrl map[string]any) (Version5, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Version5{}, err
	}
	return typedFrom[Version5](res), nil
}



func (e *Version5Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Version5Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Version5Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Version5Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Version5Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
