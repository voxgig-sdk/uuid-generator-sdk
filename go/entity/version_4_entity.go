...
func NewVersion4Entity(client *core.UuidGeneratorSDK, entopts map[string]any) *Version4Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Version4Entity) GetName() string { return e.name }
...
func (e *Version4Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Version4Entity) Deleted() bool {
	return e.deleted
}


func (e *Version4Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVersion4Entity(e.client, opts)
}

func (e *Version4Entity) Data(args ...any) any {
...
func (e *Version4Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Version4; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Version4Entity) DataTyped(data ...Version4) Version4 {
	if len(data) > 0 {
		return typedFrom[Version4](e.Data(asMap(data[0])))
	}
	return typedFrom[Version4](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Version4 (all fields
// optional at the wire level).
func (e *Version4Entity) MatchTyped(match ...Version4) Version4 {
	if len(match) > 0 {
		return typedFrom[Version4](e.Match(asMap(match[0])))
	}
	return typedFrom[Version4](e.Match())
}
...
func (e *Version4Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Version4Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Version4LoadMatch and returns an Version4. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *Version4Entity) LoadTyped(reqmatch Version4LoadMatch, ctrl map[string]any) (Version4, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Version4{}, err
	}
	return typedFrom[Version4](res), nil
}




func (e *Version4Entity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// Version4ListMatch and returns []Version4. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *Version4Entity) ListTyped(reqmatch Version4ListMatch, ctrl map[string]any) ([]Version4, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Version4](res), nil
}



func (e *Version4Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Version4Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Version4Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Version4Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
