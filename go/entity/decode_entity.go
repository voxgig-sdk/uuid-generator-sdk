...
func NewDecodeEntity(client *core.UuidGeneratorSDK, entopts map[string]any) *DecodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DecodeEntity) GetName() string { return e.name }
...
func (e *DecodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DecodeEntity) Deleted() bool {
	return e.deleted
}


func (e *DecodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDecodeEntity(e.client, opts)
}

func (e *DecodeEntity) Data(args ...any) any {
...
func (e *DecodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Decode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DecodeEntity) DataTyped(data ...Decode) Decode {
	if len(data) > 0 {
		return typedFrom[Decode](e.Data(asMap(data[0])))
	}
	return typedFrom[Decode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Decode (all fields
// optional at the wire level).
func (e *DecodeEntity) MatchTyped(match ...Decode) Decode {
	if len(match) > 0 {
		return typedFrom[Decode](e.Match(asMap(match[0])))
	}
	return typedFrom[Decode](e.Match())
}
...
func (e *DecodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DecodeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DecodeLoadMatch and returns an Decode. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DecodeEntity) LoadTyped(reqmatch DecodeLoadMatch, ctrl map[string]any) (Decode, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Decode{}, err
	}
	return typedFrom[Decode](res), nil
}



func (e *DecodeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DecodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DecodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DecodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DecodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
