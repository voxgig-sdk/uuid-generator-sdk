...
func NewVersion3Entity(client *core.UuidGeneratorSDK, entopts map[string]any) *Version3Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Version3Entity) GetName() string { return e.name }
...
func (e *Version3Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Version3Entity) Deleted() bool {
	return e.deleted
}


func (e *Version3Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVersion3Entity(e.client, opts)
}

func (e *Version3Entity) Data(args ...any) any {
...
func (e *Version3Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Version3; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Version3Entity) DataTyped(data ...Version3) Version3 {
	if len(data) > 0 {
		return typedFrom[Version3](e.Data(asMap(data[0])))
	}
	return typedFrom[Version3](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Version3 (all fields
// optional at the wire level).
func (e *Version3Entity) MatchTyped(match ...Version3) Version3 {
	if len(match) > 0 {
		return typedFrom[Version3](e.Match(asMap(match[0])))
	}
	return typedFrom[Version3](e.Match())
}
...
func (e *Version3Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Version3Entity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Version3LoadMatch and returns an Version3. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *Version3Entity) LoadTyped(reqmatch Version3LoadMatch, ctrl map[string]any) (Version3, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Version3{}, err
	}
	return typedFrom[Version3](res), nil
}



func (e *Version3Entity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *Version3Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Version3Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Version3Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Version3Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
