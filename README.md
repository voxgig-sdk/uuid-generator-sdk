...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/uuid-generator` | `npm install @voxgig-sdk/uuid-generator` |
| Python | `voxgig-sdk-uuid-generator` | `pip install voxgig-sdk-uuid-generator` |
| PHP | `voxgig-sdk/uuid-generator` | `composer require voxgig-sdk/uuid-generator` |
| Golang | `github.com/voxgig-sdk/uuid-generator-sdk/go` | `go get github.com/voxgig-sdk/uuid-generator-sdk/go` |
| Ruby | `voxgig-sdk-uuid-generator` | `gem install voxgig-sdk-uuid-generator` |
| Lua | `voxgig-sdk-uuid-generator` | `luarocks install voxgig-sdk-uuid-generator` |
