...
from uuidgenerator_sdk.utility import register

# Load features
from uuidgenerator_sdk.feature.base_feature import UuidGeneratorBaseFeature
from uuidgenerator_sdk.features import _has_feature, _make_feature
...
class UuidGeneratorSDK:
    ...
    def get_utility(self):
        return UuidGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UuidGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Decode(self, data=None) -> "DecodeEntity":
        ...
        from uuidgenerator_sdk.entity.decode_entity import DecodeEntity
    ...
    def TimestampFirst(self, data=None) -> "TimestampFirstEntity":
        ...
        from uuidgenerator_sdk.entity.timestamp_first_entity import TimestampFirstEntity
    ...
    def Version1(self, data=None) -> "Version1Entity":
        ...
        from uuidgenerator_sdk.entity.version_1_entity import Version1Entity
    ...
    def Version3(self, data=None) -> "Version3Entity":
        ...
        from uuidgenerator_sdk.entity.version_3_entity import Version3Entity
    ...
    def Version4(self, data=None) -> "Version4Entity":
        ...
        from uuidgenerator_sdk.entity.version_4_entity import Version4Entity
    ...
    def Version5(self, data=None) -> "Version5Entity":
        ...
        from uuidgenerator_sdk.entity.version_5_entity import Version5Entity
