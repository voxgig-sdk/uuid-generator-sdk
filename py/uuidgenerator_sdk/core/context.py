...
from uuidgenerator_sdk.core.control import UuidGeneratorControl
...
from uuidgenerator_sdk.core.helpers import get_ctx_prop, to_map
...
class UuidGeneratorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = UuidGeneratorControl()
        ...
        if isinstance(sp, UuidGeneratorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UuidGeneratorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UuidGeneratorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UuidGeneratorError(code, msg, self)
