# UuidGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UuidGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UuidGeneratorSDK(...) and UuidGeneratorSDK.test(...) become
#      UuidGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "uuidgenerator_sdk"
_SDK_CLASS = "UuidGeneratorSDK"
...
_ENTITIES = {
    "Decode": "decode",
    "TimestampFirst": "timestamp_first",
    "Version1": "version_1",
    "Version3": "version_3",
    "Version4": "version_4",
    "Version5": "version_5",
