...
class UuidGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UuidGeneratorTestRunner.getenv("UUIDGENERATOR_TEST_LIVE")
        override = UuidGeneratorTestRunner.getenv("UUIDGENERATOR_TEST_OVERRIDE")
        ...
        explain = UuidGeneratorTestRunner.getenv("UUIDGENERATOR_TEST_EXPLAIN")
