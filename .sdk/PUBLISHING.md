...
|---|---|---|
| `ts/` | @voxgig-sdk/uuid-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/uuid-generator-sdk \
      --repository voxgig-sdk/uuid-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/uuid-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/uuid-generator-sdk --id=<id>` removes it.
