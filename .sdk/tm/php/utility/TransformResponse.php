...
// UuidGenerator SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UuidGeneratorTransformResponse
{
    public static function call(UuidGeneratorContext $ctx): mixed
    {
        ...
        $transform = UuidGeneratorHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
