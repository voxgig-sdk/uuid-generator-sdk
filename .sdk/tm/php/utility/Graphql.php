...
// UuidGenerator SDK utility: graphql
//
...
class UuidGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(UuidGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(UuidGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
