...
// UuidGenerator SDK ratelimit feature
...
class UuidGeneratorRatelimitFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _acquire(UuidGeneratorContext $ctx): void
    {
    ...
    private function _track(UuidGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
