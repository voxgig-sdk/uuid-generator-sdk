...
// UuidGenerator SDK clienttrack feature
...
class UuidGeneratorClienttrackFeature extends UuidGeneratorBaseFeature
{
    ...
    public function PostConstruct(UuidGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UuidGenerator-SDK';
