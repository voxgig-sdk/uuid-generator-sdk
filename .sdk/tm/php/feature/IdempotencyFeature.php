...
// UuidGenerator SDK idempotency feature
...
class UuidGeneratorIdempotencyFeature extends UuidGeneratorBaseFeature
{
    ...
    private function _mutating(UuidGeneratorContext $ctx): bool
    {
