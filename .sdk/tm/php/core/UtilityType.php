...
// UuidGenerator SDK utility type

class UuidGeneratorUtility
{
    ...
    public static function copy(UuidGeneratorUtility $src): UuidGeneratorUtility
    {
        $u = new UuidGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
