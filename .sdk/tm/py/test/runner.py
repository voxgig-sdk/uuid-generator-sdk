...
class UuidGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UuidGeneratorTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UuidGeneratorTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UuidGeneratorTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
