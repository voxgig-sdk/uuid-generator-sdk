// Command UuidGenerator-mcp is an MCP server exposing the UuidGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UuidGenerator_list  — list records of an entity
//	UuidGenerator_load  — load a single record of an entity
//
