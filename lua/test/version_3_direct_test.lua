...
describe("Version3Direct", function()
  it("should direct-load-version_3", function()
    local setup = version_3_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-version_3", setup.live and "live" or "unit")
...
function version_3_direct_setup(mockres)
