...
function runner.env_override(m)
  local live = runner.getenv("UUIDGENERATOR_TEST_LIVE")
  local override = runner.getenv("UUIDGENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UUIDGENERATOR_TEST_EXPLAIN")
