...
function runner.env_override(m)
  local live = runner.getenv("UUID_GENERATOR_TEST_LIVE")
  local override = runner.getenv("UUID_GENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UUID_GENERATOR_TEST_EXPLAIN")
