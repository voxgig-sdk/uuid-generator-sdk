...
describe("Version5Direct", function()
  it("should direct-load-version_5", function()
    local setup = version_5_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-version_5", setup.live and "live" or "unit")
...
function version_5_direct_setup(mockres)
