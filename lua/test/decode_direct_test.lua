...
describe("DecodeDirect", function()
  it("should direct-load-decode", function()
    local setup = decode_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-decode", setup.live and "live" or "unit")
...
function decode_direct_setup(mockres)
