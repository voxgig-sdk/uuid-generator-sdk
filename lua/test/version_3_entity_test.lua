...
describe("Version3Entity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set UUID_GENERATOR_TEST_VERSION_3_ENTID JSON to run live")
      return
    end
...
function version_3_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("UUID_GENERATOR_TEST_VERSION_3_ENTID")
