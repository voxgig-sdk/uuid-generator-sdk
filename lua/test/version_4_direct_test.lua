...
describe("Version4Direct", function()
  it("should direct-list-version_4", function()
    local setup = version_4_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-version_4", setup.live and "live" or "unit")
  ...
  it("should direct-load-version_4", function()
    local setup = version_4_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-version_4", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function version_4_direct_setup(mockres)
