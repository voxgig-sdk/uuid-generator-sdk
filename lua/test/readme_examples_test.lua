...
local SDK_MODULE = "uuid-generator_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["decode"] = { ["test01"] = { id = "test01" } }, ["timestamp_first"] = { ["test01"] = { id = "test01" } }, ["version_1"] = { ["test01"] = { id = "test01" } }, ["version_3"] = { ["test01"] = { id = "test01" } }, ["version_4"] = { ["test01"] = { id = "test01" } }, ["version_5"] = { ["test01"] = { id = "test01" } } } }'
