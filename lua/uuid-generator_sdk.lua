...
local UuidGeneratorSDK = {}
UuidGeneratorSDK.__index = UuidGeneratorSDK
...
UuidGeneratorSDK._make_feature = _make_feature


function UuidGeneratorSDK.new(options)
  local self = setmetatable({}, UuidGeneratorSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function UuidGeneratorSDK:options_map()
...
function UuidGeneratorSDK:get_utility()
  return Utility.copy(self._utility)
end


function UuidGeneratorSDK:get_root_ctx()
  return self._rootctx
end


function UuidGeneratorSDK:prepare(fetchargs)
...
function UuidGeneratorSDK:direct(fetchargs)
...
-- by passing it.
function UuidGeneratorSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function UuidGeneratorSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "UuidGeneratorSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function UuidGeneratorSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = UuidGeneratorSDK.new(sdkopts)
  sdk.mode = "test"
