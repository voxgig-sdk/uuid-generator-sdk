-- UuidGenerator SDK Version5 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local Version5Entity = {}
Version5Entity.__index = Version5Entity


function Version5Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Version5Entity)
  self._name = "version_5"
  self._client = client
...
function Version5Entity:get_name()
  return self._name
end


function Version5Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Version5Entity.new(self._client, opts)
end
...
function Version5Entity:mark_deleted()
  self._deleted = true
end


function Version5Entity:deleted()
  return true == self._deleted
end


function Version5Entity:data_set(args)
  if args ~= nil then
...
function Version5Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Version5Entity:match_set(args)
  if args ~= nil then
...
function Version5Entity:match_get()
...
function Version5Entity:stream(action, args, callopts)
...
---@param reqmatch Version5LoadMatch
---@param ctrl? table
---@return Version5
---@return string? err
function Version5Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
function Version5Entity:_run_op(ctx, post_done)
  local utility = self._utility
