...
local Version4Entity = {}
Version4Entity.__index = Version4Entity


function Version4Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Version4Entity)
  self._name = "version_4"
  self._client = client
...
function Version4Entity:get_name()
  return self._name
end


function Version4Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Version4Entity.new(self._client, opts)
end
...
function Version4Entity:mark_deleted()
  self._deleted = true
end


function Version4Entity:deleted()
  return true == self._deleted
end


function Version4Entity:data_set(args)
  if args ~= nil then
...
function Version4Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Version4Entity:match_set(args)
  if args ~= nil then
...
function Version4Entity:match_get()
...
function Version4Entity:stream(action, args, callopts)
...
---@param reqmatch Version4LoadMatch
---@param ctrl? table
---@return Version4
---@return string? err
function Version4Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch Version4ListMatch
---@param ctrl? table
---@return Version4[]
---@return string? err
function Version4Entity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function Version4Entity:_run_op(ctx, post_done)
  local utility = self._utility
