...
local Version3Entity = {}
Version3Entity.__index = Version3Entity


function Version3Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, Version3Entity)
  self._name = "version_3"
  self._client = client
...
function Version3Entity:get_name()
  return self._name
end


function Version3Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return Version3Entity.new(self._client, opts)
end
...
function Version3Entity:mark_deleted()
  self._deleted = true
end


function Version3Entity:deleted()
  return true == self._deleted
end


function Version3Entity:data_set(args)
  if args ~= nil then
...
function Version3Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function Version3Entity:match_set(args)
  if args ~= nil then
...
function Version3Entity:match_get()
...
function Version3Entity:stream(action, args, callopts)
...
function Version3Entity:_run_op(ctx, post_done)
  local utility = self._utility
