...
(0, node_test_1.describe)('TimestampFirstDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UuidGeneratorSDK({
    ...
    (0, node_test_1.test)('direct-load-timestamp_first', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-timestamp_first', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-timestamp_first', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-timestamp_first', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UuidGeneratorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['UUID_GENERATOR_TEST_TIMESTAMP_FIRST_ENTID'];
    ...
    const client = new __1.UuidGeneratorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TimestampFirstDirect.test.js.map