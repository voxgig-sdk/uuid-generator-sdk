...
(0, node_test_1.describe)('DecodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-decode', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-decode', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UUID_GENERATOR_TEST_DECODE_ENTID'];
...
//# sourceMappingURL=DecodeDirect.test.js.map