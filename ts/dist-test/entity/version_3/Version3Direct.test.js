...
(0, node_test_1.describe)('Version3Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-version_3', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-version_3', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UUID_GENERATOR_TEST_VERSION_3_ENTID'];
...
//# sourceMappingURL=Version3Direct.test.js.map