...
(0, node_test_1.describe)('Version4Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-version_4', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-version_4', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-version_4', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-version_4', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UUID_GENERATOR_TEST_VERSION_4_ENTID'];
...
//# sourceMappingURL=Version4Direct.test.js.map