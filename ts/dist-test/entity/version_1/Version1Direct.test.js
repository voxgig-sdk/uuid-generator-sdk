...
(0, node_test_1.describe)('Version1Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-version_1', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-version_1', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-version_1', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-version_1', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['UUID_GENERATOR_TEST_VERSION_1_ENTID'];
...
//# sourceMappingURL=Version1Direct.test.js.map