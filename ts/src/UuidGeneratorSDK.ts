...
class UuidGeneratorSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('UuidGeneratorSDK: graphql: ' +
  ...
  Decode(entopts?: Record<string, any>) {
    const self = this
    return new DecodeEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  TimestampFirst(entopts?: Record<string, any>) {
    const self = this
    return new TimestampFirstEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Version1(entopts?: Record<string, any>) {
    const self = this
    return new Version1Entity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Version3(entopts?: Record<string, any>) {
    const self = this
    return new Version3Entity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Version4(entopts?: Record<string, any>) {
    const self = this
    return new Version4Entity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Version5(entopts?: Record<string, any>) {
    const self = this
    return new Version5Entity(self, entopts)
  }
