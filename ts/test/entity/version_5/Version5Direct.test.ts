...
describe('Version5Direct', async () => {
  ...
  test('direct-load-version_5', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-version_5', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['UUID_GENERATOR_TEST_VERSION_5_ENTID']
