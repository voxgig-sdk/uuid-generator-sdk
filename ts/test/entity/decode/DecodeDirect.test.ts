...
describe('DecodeDirect', async () => {
  ...
  test('direct-load-decode', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-decode', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['UUID_GENERATOR_TEST_DECODE_ENTID']
